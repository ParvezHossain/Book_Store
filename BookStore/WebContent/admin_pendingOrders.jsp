...
<body>
	...
	<div class="container_16">
		...
		<div class="grid_16" style="padding: 10px;" id="whiteBox">
			<br />
			<h1 class="grid_15">Pending Orders</h1>
			<hr />
		</div>
		<div class="clear"></div>
		<jsp:include
		...
		<div class="grid_13">
			<jsp:include
				page="includesPage/gChartings/gCharts_top10Products_Viewed720px.jsp"></jsp:include>
		</div>
	</div>
	<div class="container_16">
			...
			<form method="post" action="changeProductStatus">
				<div class="grid_16">
					<div class="grid_16" id="CartTable" style="padding: 10px 00px;">
						<h1 class="grid_15"
							style="text-align: center; padding: 10px 0px 10px 0px; border-top: 20px #444 solid;">Pending
							Orders</h1>
						...
						<%
							...
							String sql = "\n" + "SELECT `order_id` , `product_name` , \n" + " `product_price` , `product_quantity` , \n"
									+ " `sold_on` , `mobile_number` , \n" + " `address` , `shippers_name` \n" + "FROM `order` o\n"
									+ "INNER JOIN `sales` s\n" + "USING ( `order_id` )" + " WHERE `status` = 'pending' \n"
									+ "ORDER BY `order_id` ";
						...
						<div class="grid_16">
							...
							<div class="grid_3" style="border-top: 2px #444 solid;">
								...
								<%=name%>
								<br /> <br /> <input type="checkbox" class="order"
