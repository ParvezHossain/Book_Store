            ...
            <div class="grid_10 push_3">
                <form method="GET" action="addProduct">
                    <div class="grid_10">
                        ...
                        <input type="text" name= "price" tabindex="1" placeholder="eg.Tk 7899/-"/><br/>
                        <br/>
...
<div id = "footer">
    <div class="container_16">
        ...
        <div id="clear"/>
        <div class="grid_16">	
            <p>Copyrights &copy; 2017 Daffodil BookStores - The online library</p>
        </div>
    </div>
</div>
