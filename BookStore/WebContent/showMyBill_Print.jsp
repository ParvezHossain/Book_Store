...
<title>Daffodil BookStores</title>
 ...
 <div id = "" style="background: #AAA; padding: 10px; box-shadow: 0px 10px 10px #555;">
     <div class="container_16"  style="background: #AAA; ">
         <div class="grid_16">
             ...
             <div class="grid_8">
                 ...
                 <br/>West Rajabazar, Dhanmondi, Dhaka-1215, Dhaka</p> 
	...
	<div class="container_16">
		...
		<div class="grid_12 push_2" id="whiteBox" style="margin-top: 30px;">
			<div class="grid_6">
				...
				<div class="grid_2">Mobile:</div>
				<div class="grid_3">
					<%=mobileNum%>
				</div>
				<div class="grid_2">Ordered On:</div>
				<div class="grid_3">
			...
			<div class="grid_5" id="whiteBox" style="margin-top: 30px;">
				<div class="grid_5">
					...
					<div class="grid_3">Daffodil BookStores</div>
					<div class="grid_1">Email:</div>
					<div class="grid_3">parvezhossain724@gmail.com</div>
					<div class="grid_1">Address:</div>
					<div class="grid_3">West Rajabazar, Dhanmondi, Dhaka-1215,
						Dhaka</div>
					<div class="grid_1">Mobile:</div>
					<div class="grid_3">+8801745800727</div>
				</div>
			</div>
		</div>
		<%
		...
		<div id="whiteBox" class="grid_12 push_2">
			<div id="CartTable" style="padding: 10px 00px" class="grid_12">
				...
				<div class="grid_7">
					...
					<div class="clear"></div>
					<div class="grid_4">Item</div>
					<div class="grid_2">Price x Quantity</div>
				</div>
				<div class="grid_3 ">
					<h3>Total Value</h3>
				</div>
				...
				<div class="grid_12">
					<hr class="grid_11" />
					<div class="grid_4">Total Order Price</div>
	...
	<div class="container_16">
		<div class="grid_12 push_2" id="whiteBox">
			<br />
			<h1>No Product Invoice to Print</h1>
			<hr />
			<br />
		</div>
	</div>
