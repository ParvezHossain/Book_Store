...
<html>
    <head>
        ...
        <title>Daffodil Book Store</title>
        <!-- Default Stylesheets -->
                ...
                <ul id="sliderContent">		
                    ...
                    <li class="sliderImage" style="display: none; ">
                        ...
                        <span class="top" style="display: none; ">
                            ...
                            <br>From the International and Bangladeshi markets, we have the variety of the High Class fountain 
                    ...
                    <li class="sliderImage" style="display: none; ">
                        ...
                        <span class="top" style="display: none; ">
                            ...
                            International as well as Bangladheshi titles of many authors available
