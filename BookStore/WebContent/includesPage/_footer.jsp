<div id = "footer">
    <div class="container_16">
        <div class="grid_16" >
            ...
            <div class="grid_3">
                <ul>
                    <li><strong>Daffodil BookStores</strong></li>
            ...
            <div class="grid_3">
                <ul>
                    ...
                    <li><a href="https://www.facebook.com/parvez.hossain.2755" target="_blank">Facebook</a></li>
                </ul>
            </div>
            <div class="grid_5">
        ...
        <div id="clear"></div>
        <div class="grid_16">	
            <p>Copyrights &copy; 2017 Daffodil BookStores - The Online Megastore</p>
    </div>
</div>
</div>